...
*
* @brief
*  Contains functions necessary for managing output buffers
*
* @author
*  ittiam
*
...
/**
**************************************************************************
* @brief Write bitstream buffers to a file
**************************************************************************
*/
...
/**
**************************************************************************
* @brief allocate bitstream buffers
**************************************************************************
*/
void allocate_output(app_ctxt_t *ps_app_ctxt)
{
    ...
    num_bufs = MAX(DEFAULT_NUM_OUTPUT_BUFS,
                   ps_app_ctxt->s_get_buf_info_op.s_ive_op.u4_min_out_bufs);
    ...
    memset(ps_app_ctxt->as_output_buf, 0,
           sizeof(output_buf_t) * DEFAULT_MAX_OUTPUT_BUFS);
