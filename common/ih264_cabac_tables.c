...
/**
 ******************************************************************************
 * @brief combined table :guc_RTAB, NextStateLPS, NextStateMPS.
 * input  combined_state  bits 0-5: state, bits 6:mps
 * output bits 0-7: rangeTabLPS, bits 8-14 : combined_next_state_if_mps,
